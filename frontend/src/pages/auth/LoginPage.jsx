    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      ...
      <div className="w-full max-w-4xl flex flex-col md:flex-row bg-white rounded-2xl overflow-hidden shadow-[0_0_50px_rgba(79,70,229,0.15)] min-h-[600px]">
        ...
        <div className="w-full md:w-[45%] bg-indigo-600 p-8 md:p-12 flex flex-col items-center justify-center text-center text-white">
          ...
          <p className="text-indigo-100 mb-2 text-lg">Please Enter your details.</p>
          <p className="text-indigo-100 mb-8 text-lg">Don't have an account ?</p>
          <Link 
            to="/register" 
        ...
        <div className="w-full md:w-[55%] p-8 md:p-12 flex flex-col justify-center">
          <h2 className="text-4xl font-bold text-indigo-600 text-center mb-10">Log in</h2>
            ...
            <div className="space-y-5">
              <div className="relative">
                <input
                   ...
                   className={`w-full px-6 py-4 bg-slate-50 border ${errors.email ? 'border-red-500' : 'border-indigo-100'} rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-400 placeholder:text-gray-400 text-gray-700 transition-all font-medium`}
                />
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-6 py-4 bg-slate-50 border ${errors.password ? 'border-red-500' : 'border-indigo-100'} rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-400 placeholder:text-gray-400 text-gray-700 transition-all font-medium pr-12`}
                />
                <button
                  type="button"
