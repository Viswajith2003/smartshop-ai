...
const NotFoundPage = React.memo(() => {
    ...
    return (
        <div className="min-h-screen bg-[#fafafa] flex items-center justify-center p-6 font-['Inter',sans-serif]">
            ...
            <div className="fixed top-[-10%] right-[-10%] w-[50%] h-[50%] bg-indigo-500/5 blur-[120px] rounded-full"></div>
            ...
            <div className="relative z-10 max-w-2xl w-full text-center">
                ...
                <div className="mb-8 relative inline-block">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div className="w-20 h-20 md:w-28 md:h-28 bg-white rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.1)] flex items-center justify-center border border-slate-100 transform -rotate-6 animate-bounce duration-[3000ms]">
                            <i className="bi bi-compass-fill text-indigo-600 text-4xl md:text-5xl"></i>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative -mt-16 md:-mt-24">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
                        <Link 
                            to="/" 
                            className="group w-full sm:w-auto bg-slate-900 text-white font-black px-10 py-5 rounded-3xl transition-all hover:bg-indigo-600 hover:scale-105 active:scale-95 shadow-2xl shadow-slate-900/10 uppercase tracking-widest text-xs flex items-center justify-center gap-3"
                        >
                        ...
                        <button 
                            onClick={() => navigate(-1)}
                            className="group w-full sm:w-auto bg-white text-slate-600 font-black px-10 py-5 rounded-3xl border-2 border-slate-100 transition-all hover:border-indigo-400 hover:text-indigo-600 hover:scale-105 active:scale-95 shadow-lg uppercase tracking-widest text-xs flex items-center justify-center gap-3"
                        >
