                    ...
                    <div className={`flex items-center space-x-4 transition-opacity duration-300 ${isSearchOpen ? 'opacity-0 pointer-events-none md:opacity-100' : 'opacity-100'}`}>
                        ...
                        {user ? (
                            ...
                            <div className="hidden md:flex items-center space-x-3">
                                <Link 
                                    to="/login" 
                                    className="px-6 py-2.5 text-sm font-black text-indigo-600 hover:text-indigo-700 transition-colors uppercase tracking-widest"
                                >
                                    Login
                                </Link>
                                <Link 
                                    to="/register" 
                                    className="px-6 py-2.5 bg-indigo-600 text-white text-sm font-black rounded-xl hover:bg-indigo-500 transition-all shadow-md shadow-indigo-100 active:scale-95 uppercase tracking-widest"
                                >
                                    Join Now
                                </Link>
                            </div>
